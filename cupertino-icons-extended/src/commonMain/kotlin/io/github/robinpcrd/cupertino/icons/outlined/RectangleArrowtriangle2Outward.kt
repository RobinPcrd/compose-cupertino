...
val CupertinoIcons.Outlined.RectangleArrowtriangle2Outward: ImageVector
    get() {
        ...
        _rectangleArrowtriangle2Outward =
            Builder(
                name = "RectangleArrowtriangle2Outward",
                defaultWidth = 22.1719.dp,
                defaultHeight = 29.4142.dp,
                viewportWidth = 22.1719f,
                viewportHeight = 29.4142f,
            ).apply {
                path(
