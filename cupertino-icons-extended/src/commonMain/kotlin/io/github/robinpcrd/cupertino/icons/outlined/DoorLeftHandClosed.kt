...
val CupertinoIcons.Outlined.DoorLeftHandClosed: ImageVector
    get() {
        ...
        _doorLeftHandClosed =
            Builder(
                name = "DoorLeftHandClosed",
                defaultWidth = 17.8594.dp,
                defaultHeight = 24.8789.dp,
                viewportWidth = 17.8594f,
                viewportHeight =
                    24.8789f,
            ).apply {
                path(
