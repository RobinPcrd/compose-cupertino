...
val CupertinoIcons.Outlined.RectanglePortraitArrowtriangle2Outward: ImageVector
    get() {
        if (_rectanglePortraitArrowtriangle2Outward != null) {
            return _rectanglePortraitArrowtriangle2Outward!!
        }
        _rectanglePortraitArrowtriangle2Outward =
            Builder(
                name =
                    "RectanglePortraitArrowtriangle2Outward",
                defaultWidth = 29.2998.dp,
                defaultHeight =
                    22.7695.dp,
                viewportWidth = 29.2998f,
                viewportHeight = 22.7695f,
            ).apply {
                path(
