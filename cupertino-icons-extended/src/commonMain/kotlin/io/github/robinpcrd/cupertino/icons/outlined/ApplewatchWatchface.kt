...
val CupertinoIcons.Outlined.ApplewatchWatchface: ImageVector
    get() {
        if (_applewatchWatchface != null) {
            return _applewatchWatchface!!
        }
        _applewatchWatchface =
            Builder(
                name = "ApplewatchWatchface",
                defaultWidth = 16.9922.dp,
                defaultHeight = 25.0898.dp,
                viewportWidth = 16.9922f,
                viewportHeight =
                    25.0898f,
            ).apply {
                path(
