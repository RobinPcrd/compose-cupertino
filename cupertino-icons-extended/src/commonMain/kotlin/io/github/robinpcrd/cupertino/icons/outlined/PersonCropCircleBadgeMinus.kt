...
val CupertinoIcons.Outlined.PersonCropCircleBadgeMinus: ImageVector
    get() {
        if (_personCropCircleBadgeMinus != null) {
            return _personCropCircleBadgeMinus!!
        }
        _personCropCircleBadgeMinus =
            Builder(
                name = "PersonCropCircleBadgeMinus",
                defaultWidth =
                    28.3477.dp,
                defaultHeight = 24.1523.dp,
                viewportWidth = 28.3477f,
                viewportHeight =
                    24.1523f,
            ).apply {
                path(
