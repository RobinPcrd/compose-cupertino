...
val CupertinoIcons.Filled.HandPointUpLeft: ImageVector
    get() {
        ...
        _handPointUpLeft =
            Builder(
                name = "HandPointUpLeft",
                defaultWidth = 19.6983.dp,
                defaultHeight = 21.85.dp,
                viewportWidth = 19.6983f,
                viewportHeight = 21.85f,
            ).apply {
                path(
