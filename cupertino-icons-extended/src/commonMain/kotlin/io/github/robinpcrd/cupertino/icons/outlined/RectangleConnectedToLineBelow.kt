...
val CupertinoIcons.Outlined.RectangleConnectedToLineBelow: ImageVector
    get() {
        if (_rectangleConnectedToLineBelow != null) {
            return _rectangleConnectedToLineBelow!!
        }
        _rectangleConnectedToLineBelow =
            Builder(
                name = "RectangleConnectedToLineBelow",
                defaultWidth = 21.375.dp,
                defaultHeight = 26.9648.dp,
                viewportWidth = 21.375f,
                viewportHeight = 26.9648f,
            ).apply {
                path(
