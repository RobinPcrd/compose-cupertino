...
val CupertinoIcons.Outlined.ExclamationmarkIcloud: ImageVector
    get() {
        if (_exclamationmarkIcloud != null) {
            return _exclamationmarkIcloud!!
        }
        _exclamationmarkIcloud =
            Builder(
                name = "ExclamationmarkIcloud",
                defaultWidth = 29.4609.dp,
                defaultHeight = 22.2773.dp,
                viewportWidth = 29.4609f,
                viewportHeight =
                    22.2773f,
            ).apply {
                path(
