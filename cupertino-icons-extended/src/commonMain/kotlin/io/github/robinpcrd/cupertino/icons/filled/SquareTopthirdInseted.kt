...
val CupertinoIcons.Filled.SquareTopthirdInseted: ImageVector
    get() {
        if (_squareTopthirdInseted != null) {
            return _squareTopthirdInseted!!
        }
        _squareTopthirdInseted =
            Builder(
                name = "SquareTopthirdInseted",
                defaultWidth = 21.5742.dp,
                defaultHeight = 21.5977.dp,
                viewportWidth = 21.5742f,
                viewportHeight =
                    21.5977f,
            ).apply {
                path(
