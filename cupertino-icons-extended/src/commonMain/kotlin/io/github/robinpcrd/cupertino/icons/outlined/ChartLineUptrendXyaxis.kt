...
val CupertinoIcons.Outlined.ChartLineUptrendXyaxis: ImageVector
    get() {
        if (_chartLineUptrendXyaxis != null) {
            return _chartLineUptrendXyaxis!!
        }
        _chartLineUptrendXyaxis =
            Builder(
                name = "ChartLineUptrendXyaxis",
                defaultWidth =
                    25.1953.dp,
                defaultHeight = 21.8086.dp,
                viewportWidth = 25.1953f,
                viewportHeight =
                    21.8086f,
            ).apply {
                path(
