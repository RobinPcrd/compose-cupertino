...
val CupertinoIcons.Outlined.CableConnectorHorizontal: ImageVector
    get() {
        if (_cableConnectorHorizontal != null) {
            return _cableConnectorHorizontal!!
        }
        _cableConnectorHorizontal =
            Builder(
                name = "CableConnectorHorizontal",
                defaultWidth =
                    28.9922.dp,
                defaultHeight = 8.33203.dp,
                viewportWidth = 28.9922f,
                viewportHeight =
                    8.33203f,
            ).apply {
                path(
