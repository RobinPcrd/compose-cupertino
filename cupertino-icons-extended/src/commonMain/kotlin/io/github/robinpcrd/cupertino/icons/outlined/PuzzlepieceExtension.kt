...
val CupertinoIcons.Outlined.PuzzlepieceExtension: ImageVector
    get() {
        if (_puzzlepieceExtension != null) {
            return _puzzlepieceExtension!!
        }
        _puzzlepieceExtension =
            Builder(
                name = "PuzzlepieceExtension",
                defaultWidth = 28.6875.dp,
                defaultHeight = 22.6992.dp,
                viewportWidth = 28.6875f,
                viewportHeight =
                    22.6992f,
            ).apply {
                path(
