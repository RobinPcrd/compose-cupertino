...
val CupertinoIcons.Outlined.DotRadiowavesUpForward: ImageVector
    get() {
        if (_dotRadiowavesUpForward != null) {
            return _dotRadiowavesUpForward!!
        }
        _dotRadiowavesUpForward =
            Builder(
                name = "DotRadiowavesUpForward",
                defaultWidth =
                    17.6953.dp,
                defaultHeight = 17.8242.dp,
                viewportWidth = 17.6953f,
                viewportHeight =
                    17.8242f,
            ).apply {
                path(
