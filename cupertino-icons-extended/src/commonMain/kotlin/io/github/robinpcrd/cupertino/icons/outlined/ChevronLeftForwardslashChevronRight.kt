...
package io.github.robinpcrd.cupertino.icons.outlined
...
val CupertinoIcons.Outlined.ChevronLeftForwardslashChevronRight: ImageVector
    get() {
        if (_chevronLeftForwardslashChevronRight != null) {
            return _chevronLeftForwardslashChevronRight!!
        }
        _chevronLeftForwardslashChevronRight =
            Builder(
                name = "ChevronLeftForwardslashChevronRight",
                defaultWidth = 32.8477.dp,
                defaultHeight = 22.1954.dp,
                viewportWidth = 32.8477f,
                viewportHeight = 22.1954f,
            ).apply {
                path(
