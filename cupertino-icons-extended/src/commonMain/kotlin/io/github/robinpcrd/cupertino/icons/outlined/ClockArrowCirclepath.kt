...
val CupertinoIcons.Outlined.ClockArrowCirclepath: ImageVector
    get() {
        if (_clockArrowCirclepath != null) {
            return _clockArrowCirclepath!!
        }
        _clockArrowCirclepath =
            Builder(
                name = "ClockArrowCirclepath",
                defaultWidth = 26.1813.dp,
                defaultHeight = 23.918.dp,
                viewportWidth = 26.1813f,
                viewportHeight =
                    23.918f,
            ).apply {
                path(
