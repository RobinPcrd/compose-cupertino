...
package io.github.robinpcrd.cupertino.swipebox
...
import io.github.robinpcrd.cupertino.CupertinoHapticFeedback
...
internal fun AnchorsEffect(
    ...
    LaunchedEffect(parentWidth) {
        if (parentWidth > 0) {
            ...
            val fullSwipeStartOffset =
                parentWidth * (if (amountOfStartActionItems >= 2) 0.85f else 0.5f) // TODO test this
            val fullSwipeEndOffset =
                parentWidth * (if (amountOfEndActionItems >= 2) 0.85f else 0.5f) // TODO test this
            val anchors =
                DraggableAnchors {
