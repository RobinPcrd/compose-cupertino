...
val CupertinoIcons.Outlined.RectanglePortraitAndArrowForward: ImageVector
    get() {
        if (_rectanglePortraitAndArrowForward != null) {
            return _rectanglePortraitAndArrowForward!!
        }
        _rectanglePortraitAndArrowForward =
            Builder(
                name = "RectanglePortraitAndArrowForward",
                defaultWidth = 27.1992.dp,
                defaultHeight = 25.1367.dp,
                viewportWidth = 27.1992f,
                viewportHeight = 25.1367f,
            ).apply {
                path(
